...
export const ChatIcon = () => (
  <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
    <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" stroke="currentColor" {...s} />
  </svg>
);
...
// Voice heatmap toggle — a waveform glyph (reads as "voice"). adr: adr/0006-document-history-attribution.md
...
export const HelpIcon = () => (
  <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
    <circle cx="12" cy="12" r="9" stroke="currentColor" {...s} />
    <path d="M9.5 9.5a2.5 2.5 0 1 1 3.5 2.3V14" stroke="currentColor" {...s} />
