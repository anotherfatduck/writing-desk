...
function loadPersisted(): PersistedState {
  // First-run default: rail OPEN with Review active. Agent pending changes
  // are the most time-sensitive surface, so the rail opens to Review on first
  // load. User can collapse it (state persists).
  const FIRST_RUN: PersistedState = { open: true, activeTab: 'review', width: DEFAULT_WIDTH };
  try {
