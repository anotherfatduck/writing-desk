...
try {
  ...
  assert(canonForward === canonBack, 'forward-slash and back-slash converge');
  assert(canonForward === canonMixed, 'forward-slash and mixed converge');
  ...
  const outsidePath = join(homedir(), '.agent', 'skills', 'openwriter-testing', 'SKILL.md');
